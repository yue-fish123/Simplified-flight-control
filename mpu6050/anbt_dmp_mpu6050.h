...
******************************************************************************************/
#ifndef __DMP_MPU6050__H
#define __DMP_MPU6050__H
...
//static signed char gyro_orientation[9] = { 1, 0, 0, 0, 1, 0, 0, 0, 1};//网上看到的另一种版本
//
...
void AnBT_DMP_Delay_us(unsigned int dly);
